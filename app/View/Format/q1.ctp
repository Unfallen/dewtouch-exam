...
<div id="message1">
    ...
    <?php echo $this->Form->create(false, array('id'=>'form_type','type'=>'file','class'=>'','method'=>'POST','autocomplete'=>'off','inputDefaults'=>array(

        'label'=>false,'div'=>false,'type'=>'text','required'=>false),
        'url' => array('controller' => 'Format', 'action' => 'selectType'),))?>
    ...
    <?php echo $this->Form->submit('Submit', array('class' => 'btn btn-primary hidden')); ?>
